      ...
      <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>appointment/make_appointment">Make Appointment</a>
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>appointment/viewConfirmedAppoint">confirmed Appointments</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>order/viewWaitingOrders">Order requests</a>
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>order/patientOrderLog">Order Log</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>patient/editPatient">Edit Profile</a>
            <hr class="sidebar-divider">
