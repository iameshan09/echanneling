    ...
    <div class="main">
        ...
        <section class="signup">
            ...
            <div class="container2">
                ...
                <h2 class="form-title">Pending Appointments</h2>
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped">
                            ...
                            <?php if(!empty($appointments)){foreach ($appointments as $appointment){?>
                                ...
                                <td>
                                    <a href="<?php echo base_url().'appointment/acceptAppointment/'.$appointment['appoint_id']?>" class="btn btn-success">Accept
                                </td>
                                <td>
                                    <a href="<?php echo base_url().'appointment/cancelAppointment/'.$appointment['appoint_id']?>" class="btn btn-danger">Cancel
                                </td>
                            </tr>
                            <?php } }else {?>
                            <tr>
