  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion green-bg-image" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">E-Channeling</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>appointment/viewAppointQueue">Appointment request</a>
            <hr class="sidebar-divider">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Prescriptions</h6>
            <hr class="sidebar-divider">
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>schedule/viewFutureSchedules">View My Schedule</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Pharmacies</h6>
            <hr class="sidebar-divider">
            <a class="collapse-item" href="<?php echo base_url(); ?>pharmacy/viewAllPharmacies">View All Pharmacies</a>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url(); ?>doctor/editDoctorProfile">Update Profile</a>
            <hr class="sidebar-divider">
